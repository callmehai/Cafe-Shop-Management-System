...
5. **Quan hệ Product ↔ Ingredient** (recipe/BOM)
   - *Trả lời:* Đã thêm bảng trung gian `ProductIngredient` (định nghĩa công thức chế biến của mỗi món) để liên kết Product và Ingredient, từ đó hệ thống tự động trừ kho nguyên liệu khi thanh toán (BR-08).
